...
from ai_companion.graph.utils.edges import (select_workflow,
                                            should_summarize_conversation)
from ai_companion.graph.utils.nodes import (audio_node, conversation_node,
                                            image_node, router_node,
...
def create_workflow():
    ...
    workflow.add_conditional_edges("router_node", select_workflow)
